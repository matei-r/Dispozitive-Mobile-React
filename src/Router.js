...
import {InstrumentList, InstrumentEdit} from './instrument';
...
export class Router extends Component {
  ...
  renderScene(route, navigator) {
    ...
    switch (route.name) {
      ...
      case InstrumentEdit.routeName:
        return <InstrumentEdit
          store={this.props.store}
          navigator={navigator}/>
      case InstrumentList.routeName:
      default:
  ...
  onAuthSucceeded() {
    this.navigator.push(InstrumentList.route);
  }
}
